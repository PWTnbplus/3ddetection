...
load_from = None
resume = False
work_dir = './work_dirs/bevfusion_radar_cam_aligned_baseline_vod_3d_12e'

# VOD radar-camera baseline. The point branch keeps BEVFusion's
# lidar-compatible naming, but the actual point input is radar.
voxel_size = [0.16, 0.16, 0.2]
point_cloud_range = [0, -25.6, -3, 51.2, 25.6, 2]
grid_size = [320, 320, 25]
