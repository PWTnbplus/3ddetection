custom_imports = dict(
    imports=[
        'mmdet3d.models.fusion.triple_rl_bev_fusion',
        'mmdet3d.models.detectors.triple_modal_rl_voxelnet',
    ],
...
load_from = None
resume = False
work_dir = './work_dirs/pointpillars_triple_modal_rl_radar_3class_bs4'
...
text_meta_keys = (
    ...
    'text_embedding', 'text_feat', 'text_confidence', 'text_conf',
    'llm_confidence')

model = dict(
    type='TripleModalRLVoxelNet',
    ...
    fusion=dict(
        ...
        entropy_weight=0.02,
        khs_weight=0.01,
        consistency_reward_weight=0.1,
        iou_reward_weight=0.5,
        weight_jitter_weight=0.05,
        reward_scale=1.0,
        reward_clip=2.0,
        ema_momentum=0.90,
        warmup_iters=200),
...
test_pipeline = [
    ...
    dict(type='Pack3DDetInputs', keys=['points', 'img'], meta_keys=text_meta_keys)
]
...
test_evaluator = dict(
    ...
    submission_prefix='work_dirs/pointpillars_triple_modal_rl_radar_test/submission',
    backend_args=backend_args)
